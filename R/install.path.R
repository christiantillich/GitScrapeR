#' install.path
#' @description Installs every repo at a particular path, skipping over any repo
#' that is not an R repo.
...
#' @export
#' @examples install.path('users/kirillseva')
#' install.path('users/robertzk')
#' install.path('users/peterhurford')
